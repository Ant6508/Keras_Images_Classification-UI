...
in the framework of classification of images according to their belonging to a given class.

In fact, images classification with ia have never been so accessible but some people still think it is reserved for It Genius or something like this,
...
As you might understand, I am far from being a pro python developper and thus the code I wrote is meant to be easy to read and change,
...
If you are new to ia, images classification, Keras..., just know for the rest of this readme that when We talk about a "class",
It can be any object you want.
...
If you want It to recognise handwritten digits, you want to import the "1" class ...
...
To do so, get pip installed on your computer (I let the install get-pip.py in the root folder, just Python it and thats all)
...
The images importations is your first step when creating a images classification project.
...
Then just add this folder by hitting green + button, the application has know registered You want to work with this special set of images
...
Finnaly, when you are done selecting the class you want to work with, hit the 'import images' button which will copy all the images in your "data" directory 
...
If you do not know how keras layers work, try to understand as many things as you can on the keras website : https://keras.io/api/layers/ , others website
...
If not, You surely want to create and a layer to your model using the 'add a layer' button.
...
------------------
Very important : When you want a value which is a string (for exemple the activation function "relu"), You must place that strings between quotes just like in Python
activation : "relu"
Just do not do It with numbers, that will lead to errors.
------------------

You can also add some non-mandatory arguments to modify in depth the layer You want to add by chosing one of the avaible one in the bottom combobox,
